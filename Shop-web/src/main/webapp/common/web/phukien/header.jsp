...
<c:url value="/login-user.html" var="login">
</c:url>
<c:url value="/login-user.html" var="dangxuat">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-3 col-lg-3">
                <img height="100px" src="<c:url value="/template/download.png"/>">
            </div>
...
<div class="top2">
    <div class="container menu">
        <ul class="danhsach">
            ...
            <li class="muc"><a href="/phukien-canhan.html">Trang Cá nhân</a></li>

            <c:if test="${not empty name}">
                <li class="muc"><a href="${dangxuat}">${name}</a></li>
            </c:if>
            <c:if test="${ empty name}">
                <li class="muc"><a href="${login}">Login</a></li>
